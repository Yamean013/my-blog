  ...
  return (
    <main>
      ...
      <div className="animate-slide-up opacity-0">
        <p className="bg-linear-to-r from-black via-cyan-700 to-black bg-size-[200%_100%] bg-clip-text text-transparent animate-shimmer text-2xl text-center font-semibold flex items-center justify-center min-h-screen">
